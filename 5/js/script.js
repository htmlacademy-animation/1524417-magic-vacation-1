  ...
  prePareText() {
    ...
    const content = text.reduce((fragmentParent, word, wordIndex) => {
      const wordElement = Array.from(word).reduce((fragment, letter, letterIndex) => {
        ...
        element.style.transitionDelay = this._delaysArray[wordIndex][letterIndex] + `ms`;
...
/* harmony import */ var _modules_accent_typography_build__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/accent-typography-build */ "./source/js/modules/accent-typography-build.js");
// modules
...
Object.keys(accentTypographyItems).forEach((item) => {
  item = new _modules_accent_typography_build__WEBPACK_IMPORTED_MODULE_9__["default"](accentTypographyItems[item].class, accentTypographyItems[item].duration, `active`, `transform`, accentTypographyItems[item].delays);
